          ...
          {audienceItems.map((item) => {
            ...
            return (
              <div
                key={item.title}
                data-audience-item=""
                className="group relative overflow-hidden rounded-2xl border border-hairline/[0.06] bg-surface/[0.02] p-6 transition-all duration-300 hover:border-hairline/10 hover:bg-surface/[0.04] sm:rounded-[22px] sm:p-7"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-surface/[0.05] text-ink/50">
