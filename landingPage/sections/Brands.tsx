...
export function Brands() {
  return (
    <section className="relative border-y border-hairline/5 bg-[#07080B]/80 py-12 sm:py-16">
      <Reveal>
        <p className="mx-auto mb-10 max-w-[38ch] px-6 text-center text-[0.7rem] uppercase tracking-[0.32em] text-ink/38 sm:text-[0.75rem]">
